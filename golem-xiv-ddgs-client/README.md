...
```bash
./gradlew :golem-xiv-ddgs-client:test
```

**Note:** The tests will automatically run in GitHub Actions CI environment, as ubuntu-latest runners have Docker pre-installed and running by default.
